...
{
    CGFloat padding = 0.5f;
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(radiu * 2, radiu * 2), NO, [[UIScreen mainScreen] scale]);
    CGContextRef context = UIGraphicsGetCurrentContext();
    CGRect rect = CGRectMake(padding, padding, (radiu - padding)*2,(radiu - padding)*2);
    CGContextAddPath(context, [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius:(radiu - padding)].CGPath);
    CGContextSetFillColorWithColor(context, color.CGColor);
