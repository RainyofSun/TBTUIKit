...
- (void)showToast:(UIView *)toast duration:(NSTimeInterval)duration position:(id)point {
    ...
    [UIView animateWithDuration:CSToastFadeDuration
                     ...
                     animations:^{
                         ...
                         NSTimer *timer = [NSTimer tbt_scheduledTimerWithTimeInterval:duration target:self selector:@selector(toastTimerDidFinish:) userInfo:toast repeats:NO];
...
- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize lineBreakMode:(NSLineBreakMode)lineBreakMode {
    ...
    return [string tbt_sizeWithFont:font constrainedToSize:constrainedSize lineBreakMode:lineBreakMode];
}
